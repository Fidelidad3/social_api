...
// get own friend list
$app->get('/users/{id:\d+}/friends', 'FriendsController@getFriendList');
// get user list from circle
$app->get('/users/{id:\d+}/circles/{circleDepth:\d+}', 'FriendsController@getFriendCircle');