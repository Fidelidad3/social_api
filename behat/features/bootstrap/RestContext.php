...
class RestContext extends BehatContext
{
    ...
    /**
     * @Given /^that I want to (delete|remove|reject) an? /
     * @return void
     */
    ...
    /**
     * @Given /^that I want to (add|create|make|send) an? (new )?/
     * @return void
     */
    ...
    /**
     * @Given /^that I want to (change|update|approve) (an?|that) /
     * @return void
     */
    ...
    public function iRequest($pageUrl)
    {
        ...
        $pageUrl = strtr($pageUrl, $this->getMainContext()->getNodeReplaceList());
        ...
        switch (strtoupper($this->requestMethod)) {
            ...
            case self::METHOD_PUT:
                $body = json_encode($this->getMainContext()->getData());
                break;
            default:
        ...
        try {
            $this->response = $this->client
                ->$method($this->requestUrl, ['content-type' => 'application/json'], $body)
                ->send()
            ;
