...
class FeatureContext extends BehatContext implements ClosuredContextInterface
{
    ...
    /**
     * User id aliases list
     *
     * @var array
     */
    protected $_nodeReplaceList = array();
    ...
    public function __construct(array $parameters)
    {
        ...
        $this->_initNodeReplaceList();
    }

    /**
     * Init aliases array from file.
     */
    public function _initNodeReplaceList() {
        $file = dirname(__FILE__) . '/../users.txt';
        $data = unserialize(file_get_contents($file, ''));
        $this->_nodeReplaceList = $data['nodeReplaceList'];
    }
